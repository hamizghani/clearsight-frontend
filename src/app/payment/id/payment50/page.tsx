...
export default function Page50() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-['Poppins']">
      <Head>
        <title>Checkout - 50 Credits | ClearSight AI</title>
        <meta name="description" content="Purchase 50 credits for ClearSight AI" />
        ...
        <div className="flex-1 p-8 flex flex-col border-l border-gray-200">
          ...
          <div className="flex items-center justify-between py-6 border-b border-gray-200">
            <div className="bg-[#59b4ff] text-white p-4 rounded-lg flex flex-col items-center justify-center">
              <div className="text-5xl font-bold leading-none">50</div>
              <div className="text-xl font-semibold">CREDITS</div>
            </div>
            <div className="text-right">
              <div className="text-xl text-gray-600">SUBTOTAL</div>
              <div className="text-4xl font-bold">99.000 IDR</div>
