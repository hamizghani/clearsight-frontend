...
export default function TopUp() {
  ...
  const pricingOption = { price: '500.000', label: '/ month' };
  ...
  return (
    <div className="min-h-screen flex flex-col font-['Poppins']">
      ...
      <main className="flex-1 flex flex-col items-center max-w-6xl mx-auto w-full p-8">
        <h1 className="text-5xl font-bold text-center my-12 font-['Poppins']">Pricing</h1>
        <div className="flex justify-center w-full mb-12">
          <div
            ...
            onClick={() => router.push('/payment/id/subscribe')}
            tabIndex={0}
            role="button"
            onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') router.push('/payment/id/subscribe'); }}
          >
